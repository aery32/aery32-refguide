...
.. warning::
    ...
    Important! Don't forget to connect the appropriate size external pull-up resistors to your SDA and SCL pins. Try for example 4k7 value resistors. The exact optimal value depends on the SCL and the parasitic capacitance of the bus.
